...
import { Sparkles, Users, BookOpen, LineChart } from 'lucide-react';
...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="landing-page">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="card rounded-2xl p-8 shadow-lg hover:shadow-xl">
              ...
              <h3 className="text-xl font-semibold mb-3" style={{ color: 'var(--grader-violet)' }}>Duolingo-style Quizzes</h3>
            ...
            <div className="card rounded-2xl p-8 shadow-lg hover:shadow-xl">
              ...
              <h3 className="text-xl font-semibold mb-3" style={{ color: 'var(--grader-violet)' }}>Personalized Learning</h3>
            ...
            <div className="card rounded-2xl p-8 shadow-lg hover:shadow-xl">
              ...
              <h3 className="text-xl font-semibold mb-3" style={{ color: 'var(--grader-violet)' }}>Curriculum Aligned</h3>
            ...
            <div className="card rounded-2xl p-8 shadow-lg hover:shadow-xl">
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-lg mb-6" style={{ backgroundColor: '#E8E6FF' }}>
                <LineChart size={28} style={{ color: 'var(--grader-violet)' }} />
              </div>
              <h3 className="text-xl font-semibold mb-3" style={{ color: 'var(--grader-violet)' }}>Grader Lumina™ Report</h3>
      ...
      {/* Why Grader Section */}
      <section className="py-20 px-4" style={{ background: 'linear-gradient(to bottom, var(--soft-white), white)' }}>
        <div className="max-w-4xl mx-auto rounded-3xl p-8 md:p-16 text-center shadow-xl" style={{ backgroundColor: 'var(--light-lavender)' }}>
          <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: 'var(--grader-violet)' }}>Why Grader?</h2>
          <p className="text-xl text-secondary mb-10 max-w-2xl mx-auto">
            Because mastering concepts should be joyful, not stressful.
          </p>
          <button 
            className="btn btn-primary px-8 py-4 rounded-full font-semibold text-lg shadow-lg"
            style={{ background: 'linear-gradient(to right, var(--grader-violet), var(--grader-violet-dark))' }}
            onClick={() => navigate('/login')}
          >
      ...
      {/* Footer */}
      <footer className="py-8 px-4" style={{ backgroundColor: 'var(--light-lavender)' }}>
